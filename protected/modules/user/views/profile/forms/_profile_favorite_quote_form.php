...
<div class="gb-form-body row">
 ...
 <div class="form-group row gb-no-margin">
  <?php echo $form->textArea($profileModel, 'favorite_quote', array('class' => ' form-control col-lg-12 col-md-12 col-sm-12 col-xs-12', 'maxlength' => 150, 'placeholder' => 'Favorite Quote 150 characters', 'rows' => '5')); ?>
  <?php echo $form->error($profileModel, 'favorite_quote') ?>
 </div>
</div>
